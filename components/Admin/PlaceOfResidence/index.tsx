...
import PlaceOfResidenceInfos from "./PlaceOfResidenceInfos";
import {
  Button,
  Paper,
  Table,
...
import { createXLSXFileForPlaceOfResidence } from "@/lib/xlsxFileCreators";
import { createCSVFileForPlaceOfResidence } from "@/lib/csvFileCreators";
import { createJSONFileForPlaceOfResidence } from "@/lib/jsonFileCreators";
...
function PlaceOfResidence() {
  ...
  const [placeOfResidenceInfos, setPlaceOfResidenceInfos] = useState<any>([]);
  ...
  useEffect(() => {
    if (typeof window != "undefined") {
      const { url: xlsxURL } = createXLSXFileForPlaceOfResidence();
      const { url: csvURL } = createCSVFileForPlaceOfResidence();
      const { url: jsonURL } = createJSONFileForPlaceOfResidence();
  ...
  return (
    ...
    >
      ...
      {placeOfResidenceInfos.length > 0 ? (
        <TableContainer
          component={Paper}
          sx={{
            margin: "auto",
      ...
      <Upload
        ...
        whichProperty="placeOfResidence"
        setFileData={setPlaceOfResidenceInfos}
      />
      <Typography
        sx={{
          color: "#666",
