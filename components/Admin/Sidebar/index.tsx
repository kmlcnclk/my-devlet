...
import { deleteAdminAccessTokenFromLocalStorage } from '@/localstorage/adminAccessTokenStorage';
import { deleteAdminRefreshTokenFromLocalStorage } from '@/localstorage/adminRefreshTokenStorage';
...
function Sidebar({ children, pageTitle }: SidebarProps) {
  ...
  const username: string = useSelector(
    (state: RootState) => state.admin.value.name
  ) as string;
            ...
            {!routesForMenu.includes(router.asPath) && (
              <Box
                sx={{
                  ...
                  alignItems: 'center',
                  mr:
                    router.asPath == '/dashboard/create-rule' ? '50px' : '0px',
                }}
              >
                <Box
                  sx={{
                ...
                <Button
                  ...
                  onClick={() => {
                    deleteAdminAccessTokenFromLocalStorage();
                    deleteAdminRefreshTokenFromLocalStorage();
                    setTimeout(() => {
