  ...
  const addBlockChain = async (e: any) => {
    ...
    if (placeOfResidence) {
      ...
      if (ipfsHash) {
        ...
        const res = await fetch("/api/admin/placeOfResidence/addBlockchain", {
          method: "POST",
          headers: {
      ...
      toast.info("Place of Residence could not found");
    }
  };

  const getPlaceOfResidence = async () => {
    const res = await fetch(
      `/api/admin/placeOfResidence/getByUserId?userId=${userId}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
    ...
    if (!res.ok) {
      ...
      toast.success("PlaceOfResidence is successfully found");
    }
  };
