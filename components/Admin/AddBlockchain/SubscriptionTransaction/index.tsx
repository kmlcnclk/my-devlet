    ...
    if (subscriptionTransaction) {
      ...
      if (ipfsHash) {
        ...
        const res = await fetch(
          "/api/admin/subscriptionTransaction/addBlockchain",
          {
            method: "POST",
            headers: {
      ...
      toast.info("Subscription Transaction could not found");
    }
  };

  const getSubscriptionTransaction = async () => {
    const res = await fetch(
      `/api/admin/subscriptionTransaction/getByUserId?userId=${userId}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
    ...
    if (!res.ok) {
      ...
      toast.success("Subscription Transaction is successfully found");
    }
  };
    ...
    >
      {subscriptionTransaction ? (
        <SubscriptionTransactionInfoTable
          {...{ subscriptionTransaction, subscriptionTransactionTableRef }}
        />
      ) : null}
