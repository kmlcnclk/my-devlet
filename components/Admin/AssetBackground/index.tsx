...
import { createXLSXFileForAsset } from "@/lib/xlsxFileCreators";
import { createCSVFileForAsset } from "@/lib/csvFileCreators";
import { createJSONFileForAsset } from "@/lib/jsonFileCreators";
...
function AssetBackground() {
  ...
  useEffect(() => {
    if (typeof window != "undefined") {
      const { url: xlsxURL } = createXLSXFileForAsset();
      const { url: csvURL } = createCSVFileForAsset();
      const { url: jsonURL } = createJSONFileForAsset();
